'''
script to create a project folder structure, virtual 
...
def create_environment(project_name:str, requirements:list)->None:
    '''
    creates a new virtual environment with a project folder structure
    '''
    ...
    # create the gitignore file and add the venv folder
    with open(".gitignore", mode="w", encoding="utf-8") as f:
        f.write("venv\n")


if __name__ == '__main__':
    create_environment('test_project', ['numpy', 'pandas', 'matplotlib', 'type2fuzzy'])
